...
void createDataBase() async {
  var database = await openDatabase('todo.db', version: 1, onCreate: (
    ...
    database
        .execute(
            // 1. (primary key) is thing should exist in table
            // 2. in sqflite no there String it's replace by Text
            // 3. if you write text or TEXT isn't important because case sensitive
            // 4. you write title after this type (title is field and TEXT is type of filed)
